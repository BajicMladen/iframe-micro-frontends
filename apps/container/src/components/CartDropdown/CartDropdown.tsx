    ...
    <div className='absolute right-10 top-4 mt-2 bg-white border border-gray-300 shadow-lg w-80 max-h-80 overflow-y-auto z-10'>
      ...
      {cart?.length === 0 ? (
        ...
        <>
          {cart.map((item, index) => (
            ...
            >
              ...
              <div className='flex-1 ml-4 text-gray-700'>
                ...
                <div className='text-sm'>Qty: {item.quantity} × ${item.book.price?.toFixed(2)}</div>
          ...
          <div className='p-3 flex justify-between font-bold text-gray-700 border-t border-gray-300'>
            <span>Total</span>
